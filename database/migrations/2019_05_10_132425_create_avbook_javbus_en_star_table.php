...
class CreateAvbookJavbusEnStarTable extends Migration {
	...
	public function up()
	{
		Schema::create('avbook_javbus_en_star', function(Blueprint $table)
		{
			$table->string('code_36', 5)->default('')->primary();
			$table->string('star_name', 128)->nullable();
			$table->date('star_birthday')->nullable();
	...
	{
		Schema::drop('avbook_javbus_en_star');
	}
